    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            submitData = () => {
                try {
                    /** validasi inputan */
                    let storeGroupCode = $("#store-group-code-column").val();
                    let storeGroupDesc = $("#store-group-desc-column").val();  
                
                    if(storeGroupCode == "") throw "Failed Validation: Please input code";
                    // if(emailAddress == "") throw "Failed Validation:  Please input email address";
                    // if(password == "") throw "Failed Validation:  Please input password";
                    // if(storeId == "") throw "Failed Validation:  Please input store";
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{!! $properties->activeUrl !!}" + ("/create"),
                        data: {
                            _token: token,
                            group_code: storeGroupCode,
                            group_desc: storeGroupDesc,
                        },
